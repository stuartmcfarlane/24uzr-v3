...
export const MapScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','isLocked','isActive','name','lat1','lng1','lat2','lng2']);
...
export const PlanScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','status','name','ownerId','shipId','mapId','startBuoyId','endBuoyId','startTime','raceSecondsRemaining']);
